...
export default function CadastroLocatario() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!usuario.nome || !usuario.email || !usuario.senha || !usuario.confirmarSenha || !usuario.telefone || !usuario.cidade || !usuario.estado) {
    ...
    // Atualizar contexto para login automático
    login({ name: usuario.nome!, email: usuario.email! });

    // Redirecionar para home após 1s
