  ...
  return (
    <>
      ...
      <section className="px-6 md:px-20 py-16">
        ...
        <ul className="max-w-2xl mx-auto space-y-4 text-gray-700 text-lg">
      ...
      <section className="px-6 md:px-20 py-16 bg-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="p-6 bg-white shadow rounded-xl text-center">
            ...
            <p className="text-gray-600 mt-2">Tudo claro, direto e sem letras miúdas.</p>
          </div>

          <div className="p-6 bg-white shadow rounded-xl text-center">
            <h3 className="font-bold text-lg">Inovação</h3>
            <p className="text-gray-600 mt-2">Buscamos sempre melhorar a experiência de uso.</p>
          </div>
