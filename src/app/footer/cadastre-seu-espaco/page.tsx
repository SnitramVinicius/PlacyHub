  ...
  return (
    <>
      ...
      <section className="w-full min-h-[60vh] flex flex-col justify-center items-center text-center px-6 py-20">
        <h1 className="text-4xl font-bold mb-4">Cadastre seu espaço</h1>
      ...
      <section className="px-6 md:px-20 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-6 bg-gray-50 rounded-xl shadow">
            ...
            <p className="text-gray-600 mt-2">Seu espaço aparece para centenas de locatários todos os dias.</p>
          </div>
          <div className="p-6 bg-gray-50 rounded-xl shadow">
            <h3 className="font-bold text-lg">Controle total</h3>
            <p className="text-gray-600 mt-2">Gerencie agenda, regras, preços e disponibilidade facilmente.</p>
          </div>
          <div className="p-6 bg-gray-50 rounded-xl shadow">
            <h3 className="font-bold text-lg">Pagamentos seguros</h3>
            <p className="text-gray-600 mt-2">Receba de forma garantida após a confirmação da reserva.</p>
          </div>
        </div>
      </section>
