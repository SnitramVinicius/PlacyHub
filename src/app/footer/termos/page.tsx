  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <header className="mx-auto max-w-4xl px-4 py-10 text-center md:py-14">
        <h1 className="mb-4 text-4xl font-bold text-gray-900 dark:text-white md:text-5xl">Termos de Uso</h1>
        <p className="mx-auto max-w-2xl text-lg text-gray-600 dark:text-gray-300">Regras aplicáveis ao acesso e à utilização da PlacyHub por locatários, anfitriões e visitantes.</p>
        <p className="mt-3 text-sm text-gray-500 dark:text-gray-400">Última atualização: {LEGAL_LAST_UPDATED}</p>
      </header>
      <div className="mx-auto max-w-4xl px-4 pb-20"><LegalContent type="termos" /></div>
    </main>
  );
}
