  ...
  return (
    <>
      ...
      <section className="px-6 md:px-20 py-16 max-w-4xl mx-auto space-y-10 text-gray-800 leading-relaxed">
        ...
        <div>
          <h2 className="text-2xl font-bold mb-4">2. Sobre o PlacyHub</h2>
          <p>
        ...
        <div>
          <h2 className="text-2xl font-bold mb-4">3. Cadastro de Usuário</h2>
          <p>
        ...
        <div>
          <h2 className="text-2xl font-bold mb-4">4. Anúncios de Espaços</h2>
          <p>
        ...
        <div>
          <h2 className="text-2xl font-bold mb-4">5. Reservas e Pagamentos</h2>
          <p>
        ...
        <div>
          <h2 className="text-2xl font-bold mb-4">7. Uso Indevido da Plataforma</h2>
          <p>
        ...
        <div>
          <h2 className="text-2xl font-bold mb-4">9. Alterações dos Termos</h2>
          <p>
